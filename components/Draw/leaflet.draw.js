		...
		draw: {
			toolbar: {
				...
				undo: {
					...
					title: "Eliminar ultimo dibujo punto",
				...
				buttons: {
					...
					polyline: "Dibuje una polilinea",
					polygon: "Dibuje un poligono",
					rectangle: "Dibuje un rectangulo",
					circle: "Dibuje un circulo",
					marker: "Dibuje un marcador"
				}
			},
			handlers: {
				circle: {
					tooltip: {
						...
						start:"Haga clic y arrastre para dibujar el circulo."
					}
				},
				marker: {
					tooltip: {
				...
				polyline: {
					...
					error: "<strong>Error:</strong> bordes de la forma no pueden cruzar!",

					tooltip: {
						// 	start: "Click to start drawing line.",
						// 	cont: "Click to continue drawing line.",
						// 	end: "Click last point to finish line."				
						start: "Haga clic para iniciar la linea de dibujo.",
						cont: "Clic para continuar la linea de dibujo.",
						end: "Haga clic ultimo punto de la linea de meta."
					}
				},
				rectangle: {
					tooltip: {
						// start: "Click and drag to draw rectangle."
						start: "Haga clic y arrastre para dibujar rectangulo."
					}
				},
				simpleshape: {
					tooltip: {
						// end: "Release mouse to finish drawing."
						end: "Suelte el raton para completar el dibujo."
					}
				}
			}
		},
			...
			toolbar: {
				actions: {
					...
					cancel: {
						...
						// text: "Cancel"
						title: "Cancelar la edicion, descartar todos los cambios.",
						text: "Cancelar"
					}
				},
				buttons: {
			...
			handlers: {
				edit: {
					tooltip: {
						...
						text: "control de arrastre, o marcador para editar funcion.",
				...
				remove: {
					tooltip: {
						...
						text: "Haga clic en una funcion para eliminar"
					}
				}
			}
		}
